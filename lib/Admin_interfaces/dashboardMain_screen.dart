...
import 'manageMain_screen.dart';
import 'catalogue_screen.dart';
import 'profileMain_screen.dart';
...
class _DashboardMainScreenState extends State<DashboardMainScreen> {
  ...
  void initState() {
    ...
    _screens = [
      ...
      ManageMainScreen(), // Importé depuis manageMain_screen.dart
      const CatalogueScreen(), // Importé depuis catalogue_screen.dart
      const ProfileMainScreen(), // Importé depuis profile_screen.dart
    ];
  }
